...
const Computer0 = () => {
    const filteredDetails = Details.filter((detail) => detail.id === 7);
                    ...
                    <div className="images-right">
                        <div className="parts-text">
                            ...
                            <div className="parts-up">
                                ...
                                <p>
                                    <i class="fa-solid fa-check"></i>usb type-c,
                                    detachable
                                </p>
                            </div>
                            ...
                            <div className="parts-up">
                                <span>Keyboard Rollover: :</span>
                                <p>N-key, AKKO Blue/Orange/Pink V2 Switch</p>
                            </div>{" "}
                            <div className="parts-up">
                                <span>Switch Durability:</span>
                                <p>60 million presses</p>
                            </div>{" "}
                            <div className="parts-up">
                                <span>Dimensions:</span>
                                <p>360 x 140 x 40mm</p>
                            </div>{" "}
                            <div className="parts-up">
                                <span>Weight:</span>
                                <p>0.95kg </p>
