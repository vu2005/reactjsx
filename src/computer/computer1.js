...
const Computer0 = () => {
    const filteredDetails = Details.filter((detail) => detail.id === 2);
                    ...
                    <div className="images-right" key={detail.id}>
                        <div className="parts-text">
                            ...
                            <div className="parts-up">
                                ...
                                <p>
                                    i5 1360P (12 Cores, 16 Threads, 18 MB Cache,
                                    up to 5.00 GHz, Max Turbo 64W)
                                </p>
                            </div>
                            <div className="parts-up">
                                <span>Cache Memory :</span> <p>18 MB</p>
                            </div>
                            ...
                            <div className="parts-up">
                                ...
                                <p>SSD M.2 2230, SSD M.2 2280</p>
                            </div>
                            <div className="parts-up">
                                <span>Interface Type:</span>{" "}
                                <p>PCIe NVMe 3x4, PCIe NVMe 4x4</p>
                            </div>
                            <div className="parts-up">
                            ...
                            <div className="parts-up">
                                ...
                                <p>OLED (1920 x 1080 Pixels)</p>
                            </div>
                            <div className="parts-up">
                                <span>Display Technology :</span>{" "}
                                <p>Anti-Glare OLED Display</p>
                            </div>
                            <div className="parts-up">
                            ...
                            <div className="parts-up">
                                <span>USB :</span>{" "}
                                <p>
                                    1x USB-C Thunderbolt 4, 2x USB-A 3.2 Gen 1
                                </p>
                            </div>
                            <div className="parts-up">
                            ...
                            <div className="parts-up">
                                ...
                                <p>
                                    TPM 2.0, Webcam Shutter, BitLocker,
                                    Fingerprint Sensor (Depending on the
                                    version), Facial Recognition (Depending on
                                    the version)
                                </p>
                            </div>
                            ...
                            <div className="parts-up">
                                ...
                                <p>
                                    3 cell - 41 WHr, 4 cell - 54 WHr, 4 cell -
                                    64 WHr
                                </p>
                            </div>
                            <div className="parts-up">
